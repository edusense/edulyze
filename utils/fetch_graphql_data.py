...
def fetch_graphql_data(data_fetch_request, session_input_object, logger_pass, credentials_prefix=""):
    """
    ...
    logger_base = logger_pass.get('logger_base').getChild('fetch_graphql_data')
