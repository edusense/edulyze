...
def fetch_audio_data(session_input_object, logger):
    """
...
def fetch_video_data(session_input_object, logger):
    """
    ...
    instructor_video_data_raw = fetch_graphql_data(video_fetch_request, session_input_object, logger)
    ...
    student_video_data_raw = fetch_graphql_data(video_fetch_request, session_input_object, logger)
